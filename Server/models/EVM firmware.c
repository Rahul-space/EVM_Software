...
void as() {
  ...
  lcd.print("Sending message  ");
  lcd.setCursor(0, 1);
  lcd.print("authorize person  ");
  Serial.println("AT+CMGF=1");
  delay(1000);
  Serial.println("AT+CMGS=\"+919940599231\"\r"); //  AUTHORIZED PERSON NUMBER
  delay(1000);
  Serial.println(sensor1_status + sensor2_status);
  delay(1000);
  ...
  Serial.println("AT+CMGS=\"+919940599231\"\r"); //  AUTHORIZED PERSON NUMBER
  delay(1000);
  Serial.println("FINGERPRINT NOT RECOGNIZE");
  delay(1000);
  Serial.println((char)26);
  delay(5000);
  lcd.clear();
...
void VOT1() {
  ...
  Serial.println("AT+CMGF=1");
  delay(1000);
  Serial.println("AT+CMGS=\"+919677747596\"\r"); // PERSON 1
  delay(1000);
  Serial.println(sensor1_status + sensor2_status);
  delay(1000);
  Serial.println((char)26);
...
void VOT2() {
  ...
  Serial.println("AT+CMGF=1");
  delay(1000);
  Serial.println("AT+CMGS=\"+919500727827\"\r"); // PERSON 2
  delay(1000);
  Serial.println(sensor1_status + sensor2_status);
  delay(1000);
  Serial.println((char)26);
...
void VOT3() {
  ...
  Serial.println("AT+CMGF=1");
  delay(1000);
  Serial.println("AT+CMGS=\"+919600573368\"\r"); // PERSON 3
  delay(1000);
  Serial.println(sensor1_status + sensor2_status);
  delay(1000);
  Serial.println((char)26);
...
void VOT4() {
  ...
  Serial.println("AT+CMGF=1");
  delay(1000);
  Serial.println("AT+CMGS=\"+919790996037\"\r"); // person 4
  delay(1000);
  Serial.println(sensor1_status + sensor2_status);
  delay(1000);
  Serial.println((char)26);
...
void VOT5() {
  ...
  Serial.println("AT+CMGF=1");
  delay(1000);
  Serial.println("AT+CMGS=\"+919940599231\"\r"); // person 5
  delay(1000);
  Serial.println(sensor1_status + sensor2_status);
  delay(1000);
  Serial.println((char)26);
